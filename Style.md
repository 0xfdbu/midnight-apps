...
- **Code and Commands**:
  - Inline code elements like function names (`calculate_gas()`), filenames (`config.toml`), parameters (`--gas-limit`), and error messages should be enclosed in backticks.
...
**Page frontmatter** — Use consistent metadata structure:
