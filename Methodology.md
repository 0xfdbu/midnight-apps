...
| Grammar and Midnight style format | AI | Applied `Style.md` rules (active voice, sentence case, Oxford comma, etc.) | Caught AI over-edits in general — changes that altered meaning, tone, or scope were reverted |
